defmodule GardenOptimizerWeb.ConnCase do
  @moduledoc """
  ...
  by setting `use GardenOptimizerWeb.ConnCase, async: true`, although
  ...
  using do
    quote do
      ...
      use GardenOptimizerWeb, :verified_routes

      # Import conveniences for testing with connections
      import Plug.Conn
      import Phoenix.ConnTest
      import GardenOptimizerWeb.ConnCase
    end
  end
