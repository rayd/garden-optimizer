...
#
#     PHX_SERVER=true bin/garden_optimizer start
#
...
if config_env() == :prod do
  ...
  config :garden_optimizer, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :garden_optimizer, GardenOptimizer.Mailer,
